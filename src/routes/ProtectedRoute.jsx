...
import { canAccess, ROLES, STATUS_LABELS } from "../lib/roles.js";
...
export default function ProtectedRoute({ children }) {
  ...
  const { isLoaded, isSignedIn, user, profile, logout } = useAuthContext();
  ...
  const role = user?.role ?? profile?.role ?? ROLES.ADMIN;
